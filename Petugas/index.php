...
<div id="sidebar">
  ...
  <a href="index.php"><i class="icon icon-home"></i> <span>Dashboard</span></a>   
    ...
    <li <?php if ($PAGE == "Daftar") { ?> class = "active" <?php }  ?>> 
        <a href="?page=Daftar"><i class="icon icon-table"></i> <span> Pembayaran SPP</span></a> 
    </li>
    <li <?php if ($PAGE == "Detail") { ?> class = "active" <?php }  ?>> 
        <a href="?page=Detail"><i class="icon icon-book"></i> <span>Detail Pembayaran</span></a> 
    </li>
