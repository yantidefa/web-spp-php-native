    ...
    <div class="span11">
      <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          <form action="../pages/guru/prosestambah.php" method="post" class="form-horizontal">
            <div class="control-group">
              <label class="control-label">Id Guru :</label>
              <div class="controls">
                <input type="text" class="span11" id="idguru" name="idguru"  value="<?php echo autonumber('guru','idguru',7,'GRU'); ?>" required readonly>  
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">Nama Lengkap :</label>
              <div class="controls">
                <input type="text" class="span11" placeholder="Full Name" id="namaguru" name="namaguru">
              </div>
            </div>
            <div class="controls"> 
