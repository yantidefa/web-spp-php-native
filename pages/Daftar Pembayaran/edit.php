    ...
    <div class="span12">
      <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          <form action="../pages/Daftar Pembayaran/proses_tambah.php" method="POST" class="form-horizontal">
