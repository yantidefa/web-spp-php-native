    ...
    <div class="row-fluid">
      <div class="span12">
        <div class="widget-box">
          ...
          <div>
          <a href="index.php?page=Petugas&aksi=tambah" class="btn btn-round btn-primary " data-toogle="tooltip" data-placement="bottom" title="Tamba Data"><i class="icon-plus"></i> Tambah</a>
          </div>
            <table class="table table-bordered table-striped with-check" style="margin-top:10px;">
              ...
              <?php 
                $tampil = "SELECT * FROM iuran
                            INNER JOIN petugas ON iuran.id_petugas=petugas.id_petugas
                            ORDER BY iuran.no_bukti ASC";
              ...
              <tbody>
                <tr>
                  ...
                  <td><a href="../pages/Daftar Pembayaran/hapus.php?no_bukti=<?php echo $row['no_bukti'];?>" style="border-radius:3px;" class="btn btn-mini btn-danger" data-toogle="tooltip" data-placement="bottom" title="Hapus"><i class="icon-trash"></i>Hapus</a>
                     <a href="index.php?page=obat&aksi=tambah" style="border-radius:3px;" class="btn btn-mini btn-warning" data-toogle="tooltip" data-placement="bottom" title="Edit"><i class="icon-pencil"></i>Edit</a>    
