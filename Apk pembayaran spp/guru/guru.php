            ...
            <table class="table table-bordered table-striped with-check">
              ...
              <tbody>
                <tr>
                  ...
                  <td><button class="btn btn-danger btn-mini"><a href="../guru/hapus.php?idguru=<?php echo $row['idguru'];?>">Hapus</a></button>
                      <button class="btn btn-warning btn-mini"><a href="../guru/edit.php?idguru=<?php echo $row['idguru'];?>">Edit</a></button>
                  </td>
                </tr>
              </tbody>
              <?php 
