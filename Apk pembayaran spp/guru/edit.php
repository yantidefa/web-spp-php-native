...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="../index.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a><a href="guru.php" title="Go to Data Guru" class="tip-bottom"><i class="icon-home"></i> Data Guru</a> <a href="#" class="current">Edit Data Guru</a> </div>
    ...
    <div class="span6">
      <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          <form action="../guru/proses_edit.php" method="post" class="form-horizontal">
            <div class="control-group">
              <label class="control-label">ID Guru :</label>
              <div class="controls">
                <input type="text" class="span11" placeholder="Id " name="idguru" id="idguru" value="<?php echo $idguru ?>" />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">Nama :</label>
              <div class="controls">
                <input type="text" class="span11" placeholder="Full Name" name="namaguru" id="namaguru" value="<?php echo $namaguru ?>">
              </div>
            </div>
