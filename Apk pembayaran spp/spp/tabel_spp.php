...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="../index.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="current">Data Pembayaran SPP</a> </div>
            ...
            <table class="table table-bordered table-striped with-check">
              ...
              <tbody>
                <tr>
                  ...
                  <td>Row 4</td>
                  <td>Row 5</td>
                  <td><button class="btn btn-warning btn-mini"><a href="kwitansi.php">Kwitansi</a></button>
                  </td>
                </tr>
              </tbody>
            </table>
