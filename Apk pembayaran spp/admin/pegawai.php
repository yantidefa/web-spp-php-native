            ...
            <table class="table table-bordered table-striped with-check">
              ...
              <tbody>
                <tr>
                  ...
                  <td><button class="btn btn-danger btn-mini"><a href="../admin/hapus.php?idadmin=<?php echo $row['idadmin'];?>">Hapus</a></button>
                      <button class="btn btn-warning btn-mini"><a href="../admin/edit.php?idadmin=<?php echo $row['idadmin'];?>">Edit</a></button>
                  </td>
                </tr>
              </tbody>
              <?php 
