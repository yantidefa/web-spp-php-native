    ...
    <div class="span6">
      <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          <form action="../admin/proses_tambah.php" method="post" class="form-horizontal">
            <div class="control-group">
              <label class="control-label">Id Admin :</label>
              <div class="controls">
                <input type="text" class="span11" placeholder="Id " id="idadmin" name="idadmin">
              </div>
            </div>
            <div class="control-group">
            ...
            <div class="form-actions">
              <button type="submit" name="tambah" class="btn btn-success"><a href="pegawai.php?page=admin"></a>Tambah</button>
            </div>
          </form>
        </div>
      </div>
