...
<?php
$edit= "SELECT * FROM admin WHERE admin.idadmin='$id'" or die("Gagal melakukan query".mysql_error());
...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="../index.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a><a href="pegawai.php" title="Go to Data Admin" class="tip-bottom"><i class="icon-home"></i> Data Admin</a> <a href="#" class="current">Edit Data Admin</a> </div>
    ...
    <div class="span6">
      <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          <form action="../admin/proses_edit.php" method="post" class="form-horizontal">
            <div class="control-group">
              <label class="control-label">Id Admin :</label>
              <div class="controls">
                <input type="text" class="span11" placeholder="Id " id="idadmin" name="idadmin" value="<?php echo $idadmin; ?>">
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">Nama Lengkap :</label>
              <div class="controls">
                <input type="text" class="span11" placeholder="Full Name" id="namalengkap" name="namalengkap" value="<?php echo $nama; ?>">
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">Username :</label>
              <div class="controls">
                <input type="password"  class="span11" placeholder="Username" id="username" name="username" value="<?php echo $username; ?>">
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">Password :</label>
              <div class="controls">
                <input type="text" class="span11" placeholder="Password" id="password" name="password" value="<?php echo $password; ?>">
              </div>
            </div>
