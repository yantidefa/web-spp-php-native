...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="../index.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="current">Tambah Data Siswa</a> </div>
    ...
    <div class="span6">
      <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          <form action="../siswa/proses_tambah.php" method="post" class="form-horizontal">
            <div class="control-group">
              <label class="control-label">ID Siswa :</label>
              <div class="controls">
                <input type="text" class="span11" placeholder="Masukkan ID " name="idsiswa" id="idsiswa">
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">NIS :</label>
              <div class="controls">
                <input type="text" class="span11" placeholder="Masukkan NIS" name="nis" id="nis">
              </div>
            </div>
             <div class="control-group">
              <label class="control-label">Nama Siswa :</label>
              <div class="controls">
                <input type="text" class="span11" placeholder="Masukkan Nama " name="namasiswa" id="namasiswa">
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">Kelas :</label>
              <div class="controls">
                <input type="text" class="span11" placeholder="Masukkan Kelas" name="kelas" id="kelas">
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">Tahun Ajaran :</label>
              <div class="controls">
                <input type="text" class="span11" placeholder="Masukkan Tahun Ajaran" name="tahunajaran" id="tahunajaran">
              </div>
            </div>
            <div class="form-actions">
              <button type="submit" class="btn btn-success"><a href="siswa.php?page=siswa"></a>Tambah</button>
            </div>
          </form>
        </div>
      </div>
