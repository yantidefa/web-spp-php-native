...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="../index.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a><a href="walikelas.php" title="Go to Data Wali Kelas" class="tip-bottom"><i class="icon-home"></i> Data Wali Kelas</a> <a href="#" class="current">Edit Data Wali Kelas</a> </div>
        ...
        <div class="widget-content nopadding">
          <form action="#" method="get" class="form-horizontal">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="password"  class="span11" placeholder="Username"  />
              </div>
            </div>
