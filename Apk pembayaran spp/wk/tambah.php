...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="../index.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a><a href="walikelas.php" title="Go to Data Wali Kelas" class="tip-bottom"><i class="icon-home"></i> Data Wali Kelas</a> <a href="#" class="current">Tambah Data Wali Kelas</a> </div>
    ...
    <div class="span6">
      <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          <form action="../wk/proses_tambah.php" method="post" class="form-horizontal">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" class="span11" placeholder="Nama Guru" name="namaguru" id="namaguru" />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">Kelas :</label>
              <div class="controls">
                <input type="text"  class="span11" placeholder="Kelas" name="kelas" id="kelas"  />
              </div>
            </div>
            <div class="form-actions">
              <button type="submit" class="btn btn-success"><a href="walikelas.php?page=walikelas"></a>Tambah</button>
            </div>
          </form>
        </div>
      </div>
